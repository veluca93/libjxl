...
__attribute__((constructor)) void f() {
  BitWriter writer;
  coeff_order_t order[64 * 3] = {
      0, 1, 8, 9, 2, 16, 10, 17, 18, 3, 24, 11, 25, 19, 26, 4, 5, 32, 12, 33,
      27, 20, 34, 28, 13, 35, 40, 41, 21, 42, 36, 29, 22, 43, 6, 48, 49, 50, 37,
      51, 7, 14, 44, 30, 56, 15, 45, 57, 31, 38, 52, 23, 58, 59, 53, 39, 60, 46,
      54, 47, 61, 55, 62, 63,
  ...
  EncodeCoeffOrders(1, order, &writer, 0, nullptr);
  fprintf(stderr, "%zu\n", writer.BitsWritten());
