...
struct YCbCrChromaSubsampling : public Fields {
  ...
  bool Is444() const {
    return HShift(0) == 0 && VShift(0) == 0 && HShift(2) == 0 &&
           VShift(2) == 0 && HShift(1) == 0 && VShift(1) == 0;
  }

  bool Is420() const {
    return HShift(0) == 1 && VShift(0) == 1 && HShift(2) == 1 &&
           VShift(2) == 1 && HShift(1) == 0 && VShift(1) == 0;
  }

  bool Is422() const {
    return HShift(0) == 1 && VShift(0) == 0 && HShift(2) == 1 &&
           VShift(2) == 0 && HShift(1) == 0 && VShift(1) == 0;
  }

  bool Is440() const {
    return HShift(0) == 0 && VShift(0) == 1 && HShift(2) == 0 &&
           VShift(2) == 1 && HShift(1) == 0 && VShift(1) == 0;
  }
